...
export class MaintenanceController {
  ...
  @ApiOperation({
    ...
    description:
      'Crea un nuevo item de mantenimiento programado para un vehículo.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    ...
    description:
      'Obtiene todos los items de mantenimiento. Opcionalmente filtrar por vehículo.',
  })
  @ApiQuery({
    name: 'vehicleId',
    required: false,
  ...
  @ApiParam({
    ...
    example: 'cm5h8k9l0000308l5abc123def',
  })
  @ApiResponse({
    status: 200,
