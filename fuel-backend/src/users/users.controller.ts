...
export class UsersController {
  ...
  @ApiResponse({
    status: 400,
    description: 'Email ya está en uso o contraseña incorrecta',
  })
  @ApiResponse({ status: 401, description: 'No autenticado' })
  ...
  @ApiOperation({
    ...
    description:
      'Elimina permanentemente la cuenta del usuario autenticado y todos sus datos relacionados. Requiere contraseña para confirmar.',
  })
  @ApiResponse({
    status: 200,
